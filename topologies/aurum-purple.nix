...
let
  ...
  test-node = {
    ...
    region = "eu-central-1";
    producers = [
      "ioga1.relays.aurum-purple.dev.bcc.org" "ioga1.relays.aurum-white.dev.bcc.org"
      "ioga2.relays.aurum-purple.dev.bcc.org" "ioga2.relays.aurum-white.dev.bcc.org"
      "ioga3.relays.aurum-purple.dev.bcc.org" "ioga3.relays.aurum-white.dev.bcc.org"
    ];
    stakePool = false;
    public = false;
  };
