pkgs: with pkgs; with lib; rec {
  ...
  */
  withEventlog = nodes: def: lib.recursiveUpdate {
    services.bcc-node.eventlog = true;
  } def;
        ...
        let
          ...
          relaysForRegion = map (nodeIndex:
            ...
            in {
              ...
              org = "TBCO";
              services.bcc-node.maxIntraInstancesPeers = maxInRegionPeers;
            }
